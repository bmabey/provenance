...
* [![Build Status]
(https://travis-ci.org/warner/python-versioneer.png?branch=trunk)
...
* Source trees which contain multiple subprojects, such as
  ...
  "trunk" and "slave" subprojects, each with their own `setup.py`,
...
def git_versions_from_keywords(keywords, tag_prefix, verbose):
    ...
    if not tags:
        ...
        # "stabilization", as well as "HEAD" and "trunk".
