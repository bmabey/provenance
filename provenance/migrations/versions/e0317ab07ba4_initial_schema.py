...
def upgrade():
    ...
    op.create_table(
        'runs', sa.Column('id', sa.VARCHAR(length=40), nullable=False),
    ...
    op.create_table(
        'artifacts', sa.Column('id', sa.VARCHAR(length=40), nullable=False),
        ...
        sa.Column(
            'input_artifact_ids',
            pg.ARRAY(pg.VARCHAR(length=40)),
            nullable=True), sa.Column('inputs_json', pg.JSONB(), nullable=True),
