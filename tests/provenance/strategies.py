...
builtin_data = st.recursive(primitive_data | sets, lambda children: st.lists(children) | st.dictionaries(st.text(), children) | st.tuples(children))
...
data = st.recursive(primitive_data | sets | fixed_numpy_arrays, lambda children: st.lists(children) | st.dictionaries(st.text(), children) | st.tuples(children))
